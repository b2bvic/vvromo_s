...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bg text-ink font-sans selection:bg-accent selection:text-white">
      {/* Background Grid */}
      <div className="fixed inset-0 bg-grid-pattern bg-grid-sm pointer-events-none z-0 opacity-60"></div>

      {/* Navigation Bar - Heavy Duty */}
      <nav className="sticky top-0 left-0 w-full z-40 bg-surface border-b-4 border-ink shadow-brutal">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a href="https://twitter.com/b2bvic" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center border-3 border-ink bg-white hover:bg-secondary hover:text-white transition-colors hover:shadow-brutal-sm">
              <Twitter size={20} strokeWidth={3} />
            </a>
            <a href="https://linkedin.com/in/victorvalentineromo" target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center border-3 border-ink bg-white hover:bg-secondary hover:text-white transition-colors hover:shadow-brutal-sm">
      ...
      <main className="relative z-10 border-x-0 md:border-x-4 border-ink max-w-7xl mx-auto bg-surface shadow-brutal-xl my-0 md:my-12">
